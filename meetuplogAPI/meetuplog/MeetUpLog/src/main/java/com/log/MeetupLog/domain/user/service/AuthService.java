...
//4. 카카오 로그인
@Transactional
public AuthResponse loginWithKakao(Map<String, Object> attributes) {
    ...
    Map<String, Object> kakaoAccount =
            mapValue(attributes.get("kakao_account"));

    Map<String, Object> profile =
            mapValue(kakaoAccount.get("profile"));
    ...
    String kakaoNickname = stringValue(profile.get("nickname"));
    ...
    private User createKakaoUser(
        ...
        String nickname = createUniqueKakaoNickname(
                kakaoNickname,
                kakaoId
        );
    ...
    private String createUniqueKakaoNickname(
            String requestedNickname,
            String kakaoId
    ) {
        String base = requestedNickname;
        ...
        String idSuffix = kakaoId.substring(
                Math.max(0, kakaoId.length() - 6)
        );
