...
def normalize_domain_typos(text: str) -> str:
    """Apply the deterministic domain typo rules without loading ML models."""
    normalized = text
...
_normalize_domain_typos = normalize_domain_typos
...
class KoreanTextCorrector:
    ...
    def correct(self, text: str) -> CorrectionResult:
        ...
        with self._lock:
            ...
            domain_corrected = normalize_domain_typos(current)
